...
//   if (isDev) {
//     launchWindow.loadURL('http://localhost:3000/launch.html');
//     mainWindow.loadURL('http://localhost:3000');
//   } else {
//     launchWindow.loadURL(getPublicFilePath({ name: 'launch.html' }));
...
//   global.launchWindow = launchWindow;
