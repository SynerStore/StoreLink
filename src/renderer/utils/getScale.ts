// from arco-design :components/Image/utils/getScale.ts

export const defaultScales = [25, 33, 50, 67, 75, 80, 90, 100, 110, 125, 150, 175, 200, 250, 300, 400, 500];

type ZoomType = 'zoomIn' | 'zoomOut';

export class PreviewScales {
  ...
  updateScale(scales: number[]) {
    ...
    if (Array.isArray(scales) && scales.filter((num) => num > 0).length) {
