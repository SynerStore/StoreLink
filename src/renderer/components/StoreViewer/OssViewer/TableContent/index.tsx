...
const TableContent = (props: TableContentProps) => {
  ...
  // 列宽调整
  const { columnWidths, handleColumnResize } = useColumnWidths({ viewerType: 'oss' });
  ...
  ], [t, connectionId, onDownload, onRename, onDelete, onMoveTo, onCopyTo, onFileView, columnWidths]);
